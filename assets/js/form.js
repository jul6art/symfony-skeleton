...
if (VALIDATE_LOCALE !== "en") {
  require("jquery-validation/dist/localization/messages_" +
    VALIDATE_LOCALE +
    ".min");
}

// manually imported areYouSure  script
if (typeof FUNCTIONALITIES.form_watcher !== "undefined") {
  $.fn.areYouSure = function(options) {
    ...
    let checkForm = function(evt) {
      ...
      let $form = $(this).is("form") ? $(this) : $(this).parents("form");
  ...
  Plugin.prototype = {
    ...
    initHours: function() {
      ...
      for (let i = 0; i < 12; i++) {
        ...
        let svgHourCircle = this.createSVGElement("circle", {
          id: "h-" + i,
        ...
        let svgHourText = this.createSVGElement("text", {
          id: "th-" + i,
    ...
    initMinutes: function() {
      ...
      for (let i = 0; i < 60; i++) {
        ...
        let svgMinuteCircle = this.createSVGElement("circle", {
          id: "m-" + i,
      ...
      for (let i = 0; i < 60; i++) {
        if (i % 5 === 0) {
          ...
          let svgMinuteText = this.createSVGElement("text", {
            id: "tm-" + i,
    ...
    createSVGClock: function(isHour) {
      ...
      let svgElement = this.createSVGElement("svg", {
        class: "svg-clock",
        viewBox: "0,0,400,400"
      });
      let svgGElement = this.createSVGElement("g", {
        transform: "translate(200,200) "
      });
      let svgClockFace = this.createSVGElement("circle", {
        r: "192",
        fill: "#eee",
        stroke: "#bdbdbd",
        "stroke-width": 2
      });
      let svgClockCenter = this.createSVGElement("circle", {
        r: "15",
        fill: "#757575"
      });
      ...
      if (isHour) {
        let svgMinuteHand = this.createSVGElement("line", {
          class: "minute-hand",
          x1: 0,
          y1: 0,
          x2: 0,
        ...
        let svgHourHand = this.createSVGElement("line", {
          class: "hour-hand",
          x1: 0,
          y1: 0,
          x2: 0,
    ...
    refreshYearItems: function() {
      let curYear = this.currentDate.year(),
...
$.Form = {
  ...
  picker: function() {
    ...
    $("body").on(
      "change",
      '[data-provide="datepicker"], [data-provide="timepicker"], [data-provide="datetimepicker"]',
      function() {
        $(this).trigger("focus");
      }
    );
  ...
  range: function() {
    ...
    containers.each(function() {
      ...
      let options = {
        ...
        connect:
          typeof input.data("double") !== "undefined" && input.data("double")
            ? true
            : "lower",
      ...
      if (
        typeof input.data("limit") !== "undefined" &&
        input.data("limit") !== false
      ) {
